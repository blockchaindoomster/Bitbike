 ...
 */
contract BitBike is Ownable, ERC721Pausable {
    using SafeMath for uint256;
    ...
    constructor(string memory baseURI) ERC721("BitBike", "BIKE") {  
        _setBaseURI(baseURI); //"https://gateway.pinata.cloud/ipfs/"
    }
    ...
    * Mints a PACK
    */
    function mintPack(string[] memory tokenURI, uint256[] memory mintedImg, address _to) public payable saleIsOpen returns (uint256) {
        ...
        // _setTokenURI(newItemId, tokenURI[0]);
    ...
    function mintPackIndividual(string memory tokenURI, uint256 imgNum, address _to) public payable returns (uint256) {
