...
import {chainId, contractAddress, toAddress} from './constants/address';
...
const Minter = (props) => {
  ...
  const onMintPressed = async () => {
    ...
    for (var j=nextNum; j < nextNum + 1; j++) {
      mintArr.push(j)
    ...
    // var price = 0;
    // if(individualNum <= 1000) {
    //   price = 1e16
    // } else if(individualNum < 1500) {
    //   price = 5 * 1e16
    // } else if(individualNum < 3500) {
    //   price = 1e17
    // } else if(individualNum < 5000) {
    //   price = 25 * 1e16
    // } else if(individualNum < 7500) {
    //   price = 5 * 1e17
    // } else if(individualNum < 9000) {
    //   price = 1e18
    // } else {
    //   price = 2 * 1e18
    // }
